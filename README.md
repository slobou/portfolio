...
### Software Developer | Leader | Innovator | Entrepreneur

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/santiago-lobo-ulloa)
...
I'm a passionate software developer and leader from **San Jose, Costa Rica**, combining technical expertise with a drive to empower teams and create meaningful impact. Currently working as a **Frontend Engineer at BOSS.Tech**, building business automation solutions for SMB customers.

My journey spans from coding innovative solutions to leading initiatives that drive positive change — from winning science fairs to competing in international STEM competitions.
...
`React Native` `TypeScript` `Expo` `Redux` `Python`
...
`React` `TypeScript` `Expo` `Electron` `Tailwind CSS` `MongoDB`
...
**Achievement:** 1st place — Expotec 2025 Science Fair
...
- International Finals Special Mention
...
**Technical High School in Web Development**  
Don Bosco Technical High School · 2019 – 2024
...
[![LinkedIn](https://img.shields.io/badge/Let's_Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/santiago-lobo-ulloa)
